...
const Pages: FC<{}> = () => {
  return (
    <Layout title="Ways to Create Pages">
      ...
      <p>
        ...
        match their expected route. (<code className="p-1 bg-gray-200 rounded">index.tsx</code> will create a root home
        page.)
      </p>
      ...
      <p>
        You can utilize the <code className="p-1 bg-gray-200 rounded">createPages</code> function to generate pages from
        GraphQL queries or other data sources. Data can be paginated utilizing{' '}
