    ...
    <Layout>
      <main className="sm:prose-sm md:prose">
        ...
        <code className="block p-2 bg-gray-200 rounded">
          {`module.exports = { plugins: ['gatsby-plugin-image', '@lambdacurry/gatsby-theme'] };`}
        </code>
        <h3>Step 4</h3>
        <p>
          In your <code className="p-1 bg-gray-200 rounded">`./src`</code> folder create the following folders:{' '}
          <code className="p-1 bg-gray-200 rounded">`data`</code>,{' '}
          <code className="p-1 bg-gray-200 rounded">`images`</code>. These will come in handy with the{' '}
          <code className="p-1 bg-gray-200 rounded">`gatsby-source-filesystem`</code> plugin, but will also break the
          build if they do not exist.
        </p>

        <h3>Step 4</h3>
        <p>
          Try running <code className="p-1 bg-gray-200 rounded">npm develop</code> or{' '}
